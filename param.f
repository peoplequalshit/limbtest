...
c=============================================================================!
      subroutine init
      double precision tablef,alphap,betap
      common/fit/tablef(100,7,4,2),alphap,betap
      call banner 
      open(1,file='ap-table.dat',status='old')
...
c=============================================================================!
      ...
      write(*,*) '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
      write(*,*) '!                                                   !'
      write(*,*) '!  pbar+nbar spectrum in lab. frame                 !'
      write(*,*) '!  for pp, pA, Ap & AA collisions                   !'
      write(*,*) '!                                                   !'
      write(*,*) '!  if you use these data, please cite               !'
      write(*,*) '!                                                   !'
      write(*,*) '!  * M.Kachelriess, I.Moskalenko, S.Ostapchenko     !'
      write(*,*) '!    Astrophys.J. 803 (2015) 54, arxiv[1502.04158]  !'
      write(*,*) '!  * S.Ostapchenko, Phys.Rev. D86 (2012) 043004,    !'
...
!       wa2=dlog(dble(iap))/dlog(56.d0)*dlog(dble(iap)/4.d0)/dlog(14.d0)
       wa1=dlog(dble(iap)/4.d0)/dlog(4.d0)*dlog(56.d0/dble(iap))
     * /dlog(3.5d0)
       wa2=dlog(dble(iap)/4.d0)/dlog(14.d0)*dlog(dble(iap)/16.d0)
     * /dlog(3.5d0)
       wa0=1.d0-wa1-wa2
       do i=1,3
       do k=1,3
